...
%% Records
%% state
-record(state, {open_trees = {0, nil} :: gb_trees:tree(), close_sets = {0, nil} :: gb_sets:set(), parents_trees = {0, nil} :: gb_trees:tree(), dst = {0, 0} :: point(), walkable = fun(_, _) -> true end :: {Module :: module(), Function :: atom()} | fun((Id :: non_neg_integer(), Point :: point()) -> boolean())}).
%% coordinate
